...
fun UserPage(modifier: Modifier = Modifier, navController: NavController) {
    ...
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(
                onClick = { navController.navigate("adduser") }, // Changed from "addclass" to "adduser"
        ...
        Surface(
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = { Text("Search users") }, // Changed label
                    modifier = Modifier
                        .fillMaxWidth()
                        ...
                        Column(
                            ...
                            Text(
                                text = if (users.isEmpty())
                                    "No users found" // Changed message
                                else
                                    "No users match your search", // Changed message
                            ...
                            if (users.isEmpty()) {
                                Text(
                                    text = "Add a user using the + button", // Changed message
